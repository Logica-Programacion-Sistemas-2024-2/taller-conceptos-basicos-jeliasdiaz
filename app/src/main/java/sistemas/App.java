...
public class App {
    ...
    public static String convertirVelocidad(double kmPorSeg) {
        try {
            ...
            int metrosPorHora = (int) (kmPorSeg * 1000 * 3600);

            String resultado = metrosPorSeg + "|" + metrosPorHora;
    ...
    public static int convertirATotalSegundos(int dias, int horas, int minutos, int segundos) {
        try {
            ...
            int conversionHoras = horas * 60 * 60;
            int conversionMinutos = minutos * 60;
            int resultado = conversionDias + conversionHoras + conversionMinutos + segundos;
            return resultado;
        } catch (Exception e) {
            return -1;
        }
    ...
    public static int calcularSalario(int horasNormales, int horasExtrasDiurnas, int horasExtrasNocturnas, double valorHoraNormal) {
        try {
            ...
            double salarioHorasNocturnas = horasExtrasNocturnas * (valorHoraNormal + valorHoraNormal * 0.35);
            double salarioTotal = salarioNormal + salarioHorasDiurnas + salarioHorasNocturnas;
            if (horasNormales + horasExtrasDiurnas + horasExtrasNocturnas > 0) {
